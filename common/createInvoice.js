...
function generateInvoiceTable(doc, invoice) {
  ...
  generateTableRow(doc, invoiceTableTop, "Index", "name", "Email", "Gender", "isConfirmed");
  ...
  for (i = 0; i < invoice.items.length; i++) {
    ...
    generateTableRow(doc, position, i, item.firstName, item.email, item.gender, item.confirmed);
